...
Devido a essa solução ser muito ineficiente, devido à quantidade transformações de arquivos que cada consulta deveria gerar, essa atividade de consulta acaba fugindo do escopo desse projeto, que é a implementação do algoritmo de normalização para o Método das Conexões com ontologias ALC.
