 ...
 * @version $Id: RenderingVisitor.java,v 1.8 2006/03/28 16:14:45 ronwalf Exp $
 */
...
public class RenderingVisitor extends OWLObjectVisitorAdapter 
{
	...
	RenderingVisitor visitor = new RenderingVisitor( shortForms, ontology );
	if ( ind.isAnonymous() ) {
 ...
 * Revision 1.8  2006/03/28 16:14:45  ronwalf
 ...
 *
 * Revision 1.7  2004/03/30 17:46:38  sean_bechhofer
 * Changes to parser to support better validation.
 *
 * Revision 1.6  2004/01/20 17:32:49  sean_bechhofer
 * Fixing hasValue
 *
 * Revision 1.5  2004/01/08 16:07:23  dturi
 * Removed space from someValuesFrom, allValuesFrom, hasValue
 * and left bracket.
 *
 * Revision 1.4  2003/12/02 13:09:54  sean_bechhofer
 * Handling quotes and backslash in comments. Reordering of definitions.
 * Properties now come first.
 *
 * Revision 1.3  2003/11/28 11:04:35  sean_bechhofer
 ...
 * Initial Import
 *
 * Revision 1.16  2003/10/02 14:33:05  bechhofers
 * Removal of blind methods from Ontology objects.
 *
 * Revision 1.15  2003/09/10 16:45:08  bechhofers
 ...
 * More test machinery
 *
 * Revision 1.13  2003/08/20 08:39:57  bechhofers
