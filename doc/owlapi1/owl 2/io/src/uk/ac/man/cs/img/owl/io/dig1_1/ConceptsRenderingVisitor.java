 ...
 * Filename         $RCSfile: ConceptsRenderingVisitor.java,v $ 
 ...
 * to a concept in {@link org.kr.dl.dig.v1_1.Concepts}.
 * @author Daniele Turi
 * @version $Id: ConceptsRenderingVisitor.java,v 1.3 2004/06/03 14:43:16 dturi Exp $
 */
public class ConceptsRenderingVisitor extends AbstractDescriptionRenderingVisitor {

	Concepts concepts;

    /**
     * Sets the {@link Concepts} to be populated while visiting the description to
     * <code>concepts</code>.
     * @param conceptPair a {@link ConceptPair} 
     */
	public ConceptsRenderingVisitor(Concepts concepts) {
	...
	public RoleConceptPair addNewAll() {
		return concepts.addNewAll();
	}
    
    /**
     * Adds a new <code>atmost</code> to <code>concepts</code>.
     * @return the {@link NumRoleConceptPair} resulting from adding
     * a new <code>atmost</code> to <code>concepts</code>.
     */
    public NumRoleConceptPair addNewAtmost() {
        return concepts.addNewAtmost();
    }
    
    /**
     * Adds a new <code>atleast</code> to <code>concepts</code>.
     * @return the {@link NumRoleConceptPair} resulting from adding
     * a new <code>atleast</code> to <code>concepts</code>.
     */
    public NumRoleConceptPair addNewAtleast() {
        return concepts.addNewAtleast();
    }
    ...
    public StringequalsDocument.Stringequals addNewStringequals() {
        return concepts.addNewStringequals();
    }
    ...
    public IntequalsDocument.Intequals addNewIntequals() {
        return concepts.addNewIntequals();
    }
}