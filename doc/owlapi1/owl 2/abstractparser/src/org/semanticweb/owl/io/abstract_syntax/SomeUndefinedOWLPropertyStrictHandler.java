 ...
 * -----------------------
 * Filename           $RCSfile: SomeUndefinedOWLPropertyStrictHandler.java,v $
...
/**
 * Strict handler for {@link SomeUndefinedOWLPropertyException}s.
 *
 * @author <a href="mailto:dturi at cs.man.ac.uk">Daniele Turi</a>
 * @version $Id: SomeUndefinedOWLPropertyStrictHandler.java,v 1.1 2003/12/01 17:06:10 dturi Exp $
 */
    ...
    implements SomeUndefinedOWLPropertyHandler 
{
     ...
     * simply throwing <code>e</code> again.
     *
     * @param e a <code>SomeUndefinedOWLPropertyException</code> value
     * @exception SomeUndefinedOWLPropertyException <code>e</code>
     * is always thrown.
     */
