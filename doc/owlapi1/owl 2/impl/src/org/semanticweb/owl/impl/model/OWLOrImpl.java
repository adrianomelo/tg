 ...
 * @version $Id: OWLOrImpl.java,v 1.3 2006/03/28 16:14:45 ronwalf Exp $ 
 */

public class OWLOrImpl extends OWLNaryBooleanDescriptionImpl implements OWLOr
{

    public OWLOrImpl( OWLDataFactoryImpl factory, Set set ) {
	super( factory, set );
    }
