 ...
 * objects, all of which have a filler for the given role ({@link OWLDataRestriction#getDataProperty getDataProperty}) which is an element of
 * the given datatype ({@link OWLDataQuantifiedRestriction#getDataType getDataType}).
 *
 * 
 *
 *
 * @author Sean Bechhofer
 * @version $Id: OWLDataSomeRestrictionImpl.java,v 1.3 2006/03/28 16:14:45 ronwalf Exp $
 */



public class OWLDataSomeRestrictionImpl extends OWLDataQuantifiedRestrictionImpl implements OWLDataSomeRestriction
{
    public OWLDataSomeRestrictionImpl( OWLDataFactoryImpl factory,
				       OWLDataProperty property,
				       OWLDataRange dataType ) {
	super( factory, property, dataType );
    } 
...
/*
 * ChangeLog
 * $Log: OWLDataSomeRestrictionImpl.java,v $
 ...
 * Initial Import
 *
 * Revision 1.2  2003/10/03 10:00:03  bechhofers
