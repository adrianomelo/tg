 ...
 * @version $Id: OWLDisjointClassesAxiomImpl.java,v 1.3 2006/03/28 16:14:45 ronwalf Exp $
 */

public class OWLDisjointClassesAxiomImpl extends OWLClassAxiomImpl implements OWLDisjointClassesAxiom
{
    private Set disjointClasses;
    private Set ontologies;

    public OWLDisjointClassesAxiomImpl( OWLDataFactoryImpl factory,
					Set set ) {
	super( factory );
	disjointClasses = ListFactory.getSet( set );
    }
	...
	return ListFactory.getSet( disjointClasses );
    }
    ...
    public boolean equals(Object o) {
    		if (super.equals(o)) {
			if (o instanceof OWLDisjointClassesAxiom
				&& ((OWLDisjointClassesAxiomImpl) o).getDisjointClasses().equals(this.getDisjointClasses()))
				return true;			
		} 
		return false;
    }
    ...
    public int hashCode() {
    		return super.hashCode() + hashCode(ontologies) + hashCode(disjointClasses);
    }
...
/*
 * ChangeLog
 * $Log: OWLDisjointClassesAxiomImpl.java,v $
