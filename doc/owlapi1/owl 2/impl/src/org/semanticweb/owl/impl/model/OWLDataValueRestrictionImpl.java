 ...
 * objects, all of which have a filler for the given role ({@link OWLDataRestriction#getDataProperty getDataProperty}) which is the value given.
 *
 * @author Sean Bechhofer
 * @version $Id: OWLDataValueRestrictionImpl.java,v 1.3 2006/03/28 16:14:45 ronwalf Exp $ 
 */

public class OWLDataValueRestrictionImpl extends OWLDataRestrictionImpl implements OWLDataValueRestriction
{
    private OWLDataValue value;
	...
	public boolean equals(Object desc) {
		if (super.equals(desc)) {
			OWLDataValueRestrictionImpl dataValue = (OWLDataValueRestrictionImpl) desc;
			if (dataValue.getValue().equals(this.getValue())) return true;
		}
		return false;
	}
	
	public int hashCode() {
		return super.hashCode() + "hasValue".hashCode() + hashCode(value);
	}
...
/*
 * ChangeLog
 * $Log: OWLDataValueRestrictionImpl.java,v $
 ...
 *
 * Revision 1.3  2003/05/06 14:26:54  seanb
 * Some changes to the visitor hierarchies
 * Addition of datatypes
 * Fixing validation errors relating to top level intersections
 * Improved rendering (including subproperties)
 *
 * Revision 1.2  2003/04/10 12:13:06  rvolz
