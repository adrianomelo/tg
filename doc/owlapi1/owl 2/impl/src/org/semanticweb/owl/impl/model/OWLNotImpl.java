 ...
 * @version $Id: OWLNotImpl.java,v 1.3 2006/03/28 16:14:45 ronwalf Exp $ 
 */
public class OWLNotImpl extends OWLObjectImpl implements OWLNot
{
    ...
    /** Returns the {@link OWLDescription OWLDescription} being negated. */
	...
	public boolean equals(Object desc) {
		if (super.equals(desc)) {
			OWLNotImpl not = (OWLNotImpl) desc;
			if (not.operand.equals(this.operand)) return true;
		}
		return false;
	}
