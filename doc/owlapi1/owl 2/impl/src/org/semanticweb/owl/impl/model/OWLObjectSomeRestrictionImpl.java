...
/**
 * An existentially quantified restriction over a datatype property. The
 * semantics of this expression is the collection of objects, all of whom have 
 * a filler for the given role ({@link OWLObjectRestriction#getObjectProperty getObjectProperty}) which is an element of the given
 * class ({@link OWLObjectQuantifiedRestriction#getDescription getDescription}).
 *
 *
 * @author Sean Bechhofer
 * @version $Id: OWLObjectSomeRestrictionImpl.java,v 1.3 2006/03/28 16:14:45 ronwalf Exp $
 */

public class OWLObjectSomeRestrictionImpl extends OWLObjectQuantifiedRestrictionImpl implements OWLObjectSomeRestriction
{
    public OWLObjectSomeRestrictionImpl( OWLDataFactoryImpl factory,
					     OWLObjectProperty property,
					     OWLDescription description ) {
	super( factory, property, description );
    }
    ...
    public int hashCode() {
		return super.hashCode() + "existential".hashCode();
	}
    
}// IndividualSomeRestriction

/*
 * ChangeLog
 * $Log: OWLObjectSomeRestrictionImpl.java,v $
