 ...
 * @version $Id: OWLSubClassAxiomImpl.java,v 1.3 2006/03/28 16:14:45 ronwalf Exp $
 */

public class OWLSubClassAxiomImpl extends OWLClassAxiomImpl implements OWLSubClassAxiom 
{
    ...
    public boolean equals(Object o) {
    		...
    		if (super.equals(o)) {
    			OWLSubClassAxiomImpl scaObj = (OWLSubClassAxiomImpl) o;
    			if (scaObj.getSubClass().equals(this.subClass)
				&& scaObj.getSuperClass().equals(this.superClass))
					return true;
	    	}
    		return false;
    }
	...
	public int hashCode() {
		return super.hashCode() + hashCode(subClass) + hashCode(superClass);
	}
} // OWLSubClassAxiom
...
/*
 * ChangeLog
 * $Log: OWLSubClassAxiomImpl.java,v $
