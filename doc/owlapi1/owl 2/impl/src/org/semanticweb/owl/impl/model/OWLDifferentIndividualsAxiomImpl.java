 ...
 * @version $Id: OWLDifferentIndividualsAxiomImpl.java,v 1.3 2006/03/28 16:14:45 ronwalf Exp $
 */

public class OWLDifferentIndividualsAxiomImpl extends OWLIndividualAxiomImpl implements OWLDifferentIndividualsAxiom
{
    public OWLDifferentIndividualsAxiomImpl( OWLDataFactoryImpl factory,
					     Set set ) {
	super( factory, set );
    }
...
/*
 * ChangeLog
 * $Log: OWLDifferentIndividualsAxiomImpl.java,v $
