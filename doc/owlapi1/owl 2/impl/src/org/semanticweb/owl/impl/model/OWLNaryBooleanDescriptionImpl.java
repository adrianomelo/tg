 ...
 * @version $Id: OWLNaryBooleanDescriptionImpl.java,v 1.3 2006/03/28 16:14:45 ronwalf Exp $ 
 */

public abstract class OWLNaryBooleanDescriptionImpl extends OWLObjectImpl implements OWLNaryBooleanDescription 
{
    ...
    public OWLNaryBooleanDescriptionImpl( OWLDataFactoryImpl factory,
					  Set set ) {
	super( factory );
	operands = ListFactory.getSet( set );
    }
    
    /** Returns a list of {@link OWLDescription OWLDescription}s which are the operands to the expression. */
    public Set getOperands() {
	return ListFactory.getSet(operands);
    }

    public boolean equals(Object obj) {
    		if (super.equals(obj)) {
    			if (((OWLNaryBooleanDescriptionImpl)obj).operands.equals(operands)) {
    				return true;
    			}
    		}
    		return false;
    	...
    	public int hashCode() {
    		return super.hashCode() + hashCode(operands);
    	}
...
/*
 * ChangeLog
 * $Log: OWLNaryBooleanDescriptionImpl.java,v $
