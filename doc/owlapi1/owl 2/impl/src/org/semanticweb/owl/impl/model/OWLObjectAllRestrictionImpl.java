 ...
 * whose fillers for the given role ({@link OWLObjectRestriction#getObjectProperty getObjectProperty}) are elements of the given
 * class ({@link OWLObjectQuantifiedRestriction#getDescription getDescription}).
 *
 * IndividualAllRestriction.java
 *
 *
 * @author Sean Bechhofer 
 * @version $Id: OWLObjectAllRestrictionImpl.java,v 1.3 2006/03/28 16:14:45 ronwalf Exp $
 */

public class OWLObjectAllRestrictionImpl extends OWLObjectQuantifiedRestrictionImpl implements OWLObjectAllRestriction
{
    ...
    public int hashCode() {
		return super.hashCode() + "universal".hashCode();
	}
...
/*
 * ChangeLog
 * $Log: OWLObjectAllRestrictionImpl.java,v $
