 ...
 * -----------------------
 * Filename           $RCSfile: OWLFullConstructRDFException.java,v $
 * Revision           $Revision: 1.1.1.1 $
 * Release status     $State: Exp $
 * Last modified on   $Date: 2003/10/14 17:10:18 $
 ...
 * DatatypeProperty. Extends {@link org.xml.sax.SAXException org.xml.sax.SAXException} in order to allow it to be thrown in the
 * Parsers.
 *
 *
 *
 ...
 * @version $Id: OWLFullConstructRDFException.java,v 1.1.1.1 2003/10/14 17:10:18 sean_bechhofer Exp $
 */

public class OWLFullConstructRDFException extends org.xml.sax.SAXException 
{
...
} // OWLFullConstructException



/*
 * ChangeLog
 * $Log: OWLFullConstructRDFException.java,v $
