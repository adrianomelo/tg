...
/**
 * A Restriction over an {@link OWLObjectProperty OWLIndividualProperty} that is
 * quantified. Subinterfaces specify the quantifier.

 *
 * @author Sean Bechhofer
 * @version $Id: OWLObjectQuantifiedRestriction.java,v 1.2 2005/06/10 12:20:29 sean_bechhofer Exp $ 
 */

public interface OWLObjectQuantifiedRestriction extends OWLObjectRestriction
{
    public OWLDescription getDescription() throws OWLException;
 
}// OWLIndividualQuantifiedRestriction


/*
 * ChangeLog
 * $Log: OWLObjectQuantifiedRestriction.java,v $
