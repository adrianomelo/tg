...
* A Visitor for OWL entities objects. See <i>Design
 ...
 OWLClassAxiom hierarchy, a function <CODE>visitConcrete(Concrete)</CODE>
 must be provided.

 <BR><BR> The expression can then be visited using the {@link OWLClassAxiom#accept(OWLClassAxiomVisitor) accept} method.
 ...
 {@link OWLClassAxiom OWLClassAxiom} change, then the implementors of this
 interface may need to change accordingly.

 *
 * @author Sean Bechhofer
 * @version $Id: OWLClassAxiomVisitor.java,v 1.3 2006/03/28 16:14:45 ronwalf Exp $
 */

public interface OWLClassAxiomVisitor extends Serializable
{
...
/*
 * ChangeLog
 * $Log: OWLClassAxiomVisitor.java,v $
