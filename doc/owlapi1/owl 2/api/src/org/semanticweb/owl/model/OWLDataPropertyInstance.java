 ...
 * -----------------------
 * Filename           $RCSfile: OWLDataPropertyInstance.java,v $
 ...
 * @version $Id: OWLDataPropertyInstance.java,v 1.1.1.1 2003/10/14 17:10:08 sean_bechhofer Exp $
 */

public interface OWLDataPropertyInstance extends OWLPropertyInstance 
{
    public OWLDataProperty getProperty() throws OWLException;
    public OWLDataValue getObject() throws OWLException;
...
/*
 * ChangeLog
 * $Log: OWLDataPropertyInstance.java,v $
 ...
 *
 * Revision 1.3  2003/04/10 12:08:50  rvolz
