 ...
 * -----------------------
 * Filename           $RCSfile: RemoveAnnotationInstance.java,v $
...
public class RemoveAnnotationInstance extends OntologyChange
{
    private OWLObject subject;
    private OWLAnnotationProperty property;
    private Object content;

    public RemoveAnnotationInstance( OWLOntology ontology,
				  OWLObject subject,
...
/*
 * ChangeLog
 * $Log: RemoveAnnotationInstance.java,v $
