 ...
 * @version $Id: OWLEquivalentClassesAxiom.java,v 1.2 2005/06/10 12:20:28 sean_bechhofer Exp $
 */

public interface OWLEquivalentClassesAxiom extends OWLClassAxiom 
{
    /** Returns a collection of {@link OWLDescription OWLDescription}s which
     * are the descriptions asserted to be equivalent. */ 
    public Set getEquivalentClasses() throws OWLException;
...
/*
 * ChangeLog
 * $Log: OWLEquivalentClassesAxiom.java,v $
