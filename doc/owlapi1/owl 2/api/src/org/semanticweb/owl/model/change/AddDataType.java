 ...
 * @version $Id: AddDataType.java,v 1.2 2005/06/10 12:20:29 sean_bechhofer Exp $
 */

public class AddDataType extends OntologyChange
{
	...
	try {
	    return "Add: " + datatype.getURI() + " to " + ontology.getURI();
