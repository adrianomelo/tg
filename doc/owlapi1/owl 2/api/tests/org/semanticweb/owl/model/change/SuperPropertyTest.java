 ...
 * @version $Id: SuperPropertyTest.java,v 1.2 2005/06/10 12:20:30 sean_bechhofer Exp $
 */

public class SuperPropertyTest extends TestCase
{
	...
	/* Entity tests */
	suite.addTest( new SuperPropertyTest( "testSuperProperty",
					  fact,
					  o,
					  cv ) );
	return suite;
    ...
    public SuperPropertyTest( String name, 
			  OWLDataFactory fact,
			  OWLOntology o, 
			  ChangeVisitor cv )
    {
    ...
    public void testSuperProperty() throws Throwable {
	/* Get a new object property */
	OWLProperty prop1 = factory.getOWLObjectProperty( TestUtils.newURI() );
	OWLProperty prop2 = factory.getOWLObjectProperty( TestUtils.newURI() );
	
	/* Get a new change object */
	OntologyChange oc = new AddSuperProperty( ontology,
						  prop1,
						  prop2,
						  null );
	/* Add it */
	oc.accept( visitor );
	assertTrue( prop1.getSuperProperties( ontology ).contains( prop2 ) );
	
	/* Now try with a data property */
	prop1 = factory.getOWLDataProperty( TestUtils.newURI() );
	prop2 = factory.getOWLDataProperty( TestUtils.newURI() );
	
	/* Get a new change object */
	oc = new AddSuperProperty( ontology,
				   prop1,
				   prop2,
				   null );
	/* Add it */
