...
/**
 * Test basic methods on {@link OWLIndividual OWLIndividual}.
 *
 *
 * @author Sean Bechhofer
 * @version $Id: OWLIndividualTest.java,v 1.2 2005/06/10 12:20:30 sean_bechhofer Exp $
 */

public class OWLIndividualTest extends TestCase 
{
	...
	try {
	    TestSuite suite = new TestSuite ("OWLIndividual");
	    /* Entity tests */
	    OWLIndividual individual = 
		factory.getOWLIndividual(TestUtils.newURI());
	    ...
	    suite.addTest( new OWLNamedObjectTest( "testURI",
						   individual ) );
	    suite.addTest( new OWLIndividualTest( "testAccessors",
						  ontology,
						  individual ) );
	    return suite;
	...
	try {
	    assertNotNull( individual.getTypes( ontology ) );
	    assertNotNull( individual.getDataPropertyValues( ontology ) );
	    assertNotNull( individual.getObjectPropertyValues( ontology ) );
 ...
 * Initial Import
 *
 * Revision 1.5  2003/10/02 14:33:06  bechhofers
 * Removal of blind methods from Ontology objects.
 *
 * Revision 1.4  2003/05/27 08:44:36  seanb
 * no message
 *
