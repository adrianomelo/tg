 ...
 * @version $Id: AddEntityTest.java,v 1.2 2005/06/10 12:20:30 sean_bechhofer Exp $
 */

public class AddEntityTest extends TestCase
{
	...
	TestSuite suite = new TestSuite ("AddEntity");
	/* Entity tests */
	suite.addTest( new AddEntityTest( "testAddClass",
					  fact,
					  o,
					  cv ) );
	suite.addTest( new AddEntityTest( "testAddIndividual",
					  fact,
					  o,
					  cv ) );
	suite.addTest( new AddEntityTest( "testAddObjectProperty",
					  fact,
					  o,
					  cv ) );
	suite.addTest( new AddEntityTest( "testAddDataProperty",
					  fact,
					  o,
					  cv ) );
	return suite;
    ...
    public void testAddIndividual() throws Throwable {
    ...
    public void testAddDataProperty() throws Throwable {
	/* Get a new individual */
